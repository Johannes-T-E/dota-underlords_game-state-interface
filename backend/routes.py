"""
Flask Routes - API endpoints and React app serving
"""
import os
from flask import request, jsonify, render_template, send_from_directory
from datetime import datetime
from .match_state import match_state, db, db_write_queue, connected_clients
from .match_manager import abandon_match
from .gsi_processor import process_gsi_data
